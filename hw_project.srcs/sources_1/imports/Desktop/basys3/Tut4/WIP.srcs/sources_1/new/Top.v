...
//    reg [10:0] palette_foam2 [0:1223];
    reg [7:0] palette_drive [0:576];
    reg [7:0] palette_foam [0:576];
    reg [7:0] palette_jane [0:576];
    reg [7:0] palette_porsche [0:576];
    reg [7:0] palette_tien [0:576];
    reg [7:0] palette_undertale [0:576];    
    reg [7:0] palette_press [0:576];
    reg [7:0] palette_heart [0:224];
